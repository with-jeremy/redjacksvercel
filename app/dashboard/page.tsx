...
export default async function Dashboard() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-8">Venue Manager Dashboard</h1>
      <Link
        href="/dashboard/create-event"
        className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mb-8 inline-block"
      >
        Create New Event
      </Link>
      <div className="mt-8">
